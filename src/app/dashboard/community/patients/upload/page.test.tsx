...
console.log('⚡ page.test.tsx loaded');
...
describe('UploadPatientDocsPage', () => {
  ...
  it.skip('shows preview when image selected' , async () => {
    render(<UploadPatientDocsPage />)
  ...
  it.skip('validates file type and size' , async () => {
    render(<UploadPatientDocsPage />)
    ...
    expect(alerts.some(t => t?.includes('PDF'))).toBeTruthy()
  })

  it.skip('submits valid files and redirects', async () => {
    render(<UploadPatientDocsPage />)
  ...
  it.skip('shows error toast on upload failure' , async () => {
  ...
  it.skip('shows preview when PDF selected' , async () => {
    render(<UploadPatientDocsPage />)
